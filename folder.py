...
source = r'C:\Users\wierd\Documents\GitHub\Deep-Learning-Final-Proj\Dataset\Test/Anime/'
destination = r'C:\Users\wierd\Documents\GitHub\Deep-Learning-Final-Proj\Dataset\Test2/Cartoon/'

allfiles = os.listdir(source)
for f in allfiles:
    shutil.copyfile(source + f, destination + f)

source = r'C:\Users\wierd\Documents\GitHub\Deep-Learning-Final-Proj\Dataset\Test/Cartoon/'
